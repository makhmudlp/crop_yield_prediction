# Machine Learning Regression for Crop Yield Prediction
...
The repo currently consists of a single Jupyter notebook that implements the full experimental pipeline.
...
```text
.
├── Soil_Yield_Regression.ipynb   # main notebook with all experiments
└── README.md
